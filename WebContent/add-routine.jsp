...
<div class="main">
	...
	<hr>
	<h1><i class="fas fa-dumbbell"></i> Add Workout Routine</h1>
	<p> To add a workout routine to the database, please fill out the following fields:</p>
    ...
    %>
  	...
  	<form id="add-routine" action="AddRoutineServlet" method="post" enctype="multipart/form-data">
  		<section class="first">
          	<fieldset class="first_fieldset">
              	<legend>Workout Routine</legend>
              	<label> Workout Routine Name: </label><br>
              	<input type="text" name = "name" size="25"><br>
              	<label> Workouts (Choose up to 10): </label>
              	<select name="workout1">
              		<option selected disabled value="-1">Select Workout</option>
				    <%
                ...
                <br><label> Workout Routine Image: </label><br>
