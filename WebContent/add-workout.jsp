  	...
  	<form id="add-workout" action="AddWorkoutServlet" method="post" enctype="multipart/form-data">
  		<section class="first">
          	<fieldset class="first_fieldset">
			    ...
			    //connection.close();
			    while(rs.next()){
				    out.println("<input type=\"checkbox\" name=\"equipment\" value=\"" + rs.getString("name") + "\"> " + rs.getString("name") + "<br>");
			    }
				%>
			    ...
			    while(rs.next()){
			    	...
			    	out.println("<br><label> " + rs.getString("name")+ " </label><br>");
				    ...
				    while(rs2.next()){
				    	out.println("<input type=\"checkbox\" name=\"muscles\" value=\"" + rs2.getString("name") + "\"> " + rs2.getString("name")+ "<br>");
				    }
			    }
                ...
                <input type="text" name="video" pattern="^(https?\:\/\/)?(www\.)?(youtube\.com|youtu\.?be)\/.+$"><br>
