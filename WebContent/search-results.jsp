...
<% 
    ...
    String query = "SELECT * FROM workout WHERE name LIKE ? OR equipment " +
    		"LIKE ? OR muscles LIKE ? OR skill_level LIKE ? OR type LIKE ?" +
    ...
    pstmt.setString(5, search_pattern);
    pstmt.setString(6, search_pattern);
...
while(rs.next()){	
	out.println("<div class=\"row\">  "  + 
			 ...
			 "           <p>Body Parts: " + rs.getString("muscles") + "</p>  "  + 
